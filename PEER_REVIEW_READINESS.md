...
| **D6** Relativistic Stability | ⚠️ [P/O] | **Ghost-free re-check CLOSED 2026-09-12** (`TARGET_D1_SUPPLEMENT` §5 re-run): J′>0, J″>0, J′+2𝒴J″>0 identically for all 𝒴>0 under F_std=½[x√(1+x²)−arsinh x]; deep-MOND J→(2λ_s/3a₀)𝒴^{3/2}, Newtonian J→λ_s𝒴. Remaining D6 scope: full Hamiltonian analysis under AeST beyond the kinetic sector | ⚠️ |
