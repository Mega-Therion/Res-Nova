...
\textbf{Important provenance note:} The recorded PASS was obtained on the author's machine with a pre-built Mathlib cache. Cold-clone reproducibility (\texttt{lake exe cache get} on a blank machine) is documented as open problem O6 in \texttt{OPEN\_PROBLEMS\_AND\_TESTS.md} and is not a current claim.
