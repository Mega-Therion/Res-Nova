...
\small Formal Verification: \texttt{Res Nova} Lean 4 Formal Kernel (17 Modules, 16 Sorry-Free)}
...
The mathematical core of Geometrically Ordered Dynamics is formalized in Lean 4 (\texttt{Res Nova} kernel). The verification suite operates under a strict four-axiom foundational budget: \texttt{propext}, \texttt{Classical.choice}, \texttt{Quot.sound}, and \texttt{flatness\_iff\_trivial\_holonomy}.
...
\texttt{HedgehogSoldering.lean} & \texttt{hedgehog\_stress\_isotropic} & Isotropy of spatial hedgehog stress tensor & \textbf{1 sorry} \\
\bottomrule
\end{tabularx}
\caption{Lean 4 Formal Verification Ledger across core \texttt{ChyrenLogic} modules (16/17 sorry-free under 4-axiom budget (1 sorry in \texttt{HedgehogSoldering.lean})).}
\end{table}
