...
The tracked Lean~4 sources under \texttt{05\_lean\_formalization/} comprise \textbf{19 modules},
...
\end{tabularx}
\caption{Headline declarations in the 19 tracked Lean~4 source modules, enumerated from
